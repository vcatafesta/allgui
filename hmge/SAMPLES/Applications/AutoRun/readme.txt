...
// Section data
// FilmName - film title
// Info_File - description filename
// Info_Type - type if description file shown (txt, html)
// Info_Aligment - alignment in file description (only for txt-format)
// Picture - picture
// FilmName_File - filename file to play by standard windows mediaplayer
// Command_Line - command line
// Images_Dir - folder of shortcut picture
// PathXviD - driver filename
// Exit_Button_Click - exit after a button click
...
// Buttons_Font_Color - font color on a buttons
