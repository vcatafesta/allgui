      ...
      DEFINE WINDOW Form_2                        ;
         ...
         DEFINE TAB Tab_1    ;
            ...
            PAGE '&Options'
               ...
               @ 240, 20 RADIOGROUP RadioGroup_1            ;
                  OPTIONS {aLabel[1], aLabel[2], aLabel[3]}      ;
                  VALUE nState WIDTH 176 SPACING 24         ;
...
PROCEDURE SetRadio_1()

   LOCAL c := GetControlHandle("RadioGroup_1", "Form_2")

   MoveWindow ( c[3] , 27 , 297 , 150 , 24 , .t. )
