   ...
   DEFINE WINDOW Form_1 ;
      ...
      DEFINE MAIN MENU
         POPUP 'File'
            ...
            SEPARATOR
            ITEM 'Paint Double Buffer'   ACTION { lDoubleBuffer := ListView_GetExtendedStyle ;
               ( GetControlHandle( 'Browse_1' , 'Form_1' ), LVS_EX_DOUBLEBUFFER ), ;
               PaintDoubleBuffer( !lDoubleBuffer ) } NAME menu_db CHECKED
            SEPARATOR
