...
#define AVOID_COMPILER_WARNING   // Claudio Soto (November 2013)
...
BOOL _SET_LISTVIEW_DELETEALLITEMS_ = FALSE;   // for compatibility with old behavior of LISTVIEW_ADDCOLUMN and LISTVIEW_DELETECOLUMN
