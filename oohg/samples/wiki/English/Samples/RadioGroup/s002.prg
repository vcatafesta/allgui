...
FUNCTION Main
   ...
   DEFINE WINDOW Form_1 ;
      ...
      @ 10, 450 LABEL lbl_151 WIDTH 100 HEIGHT 15 TRANSPARENT VALUE "THEMED"
      ...
      @ 10, 780 LABEL lbl_181 WIDTH 100 HEIGHT 15 TRANSPARENT VALUE "THEMED"
      ...
      @ 210, 10 LABEL lbl_211 WIDTH 100 HEIGHT 15 TRANSPARENT VALUE "NOTHEME"
      ...
      @ 210, 340 LABEL lbl_241 WIDTH 100 HEIGHT 15 TRANSPARENT VALUE "NOTHEME"
      ...
      @ 410, 10 LABEL lbl_Notes WIDTH 500 HEIGHT 200 TRANSPARENT ;
         VALUE "BACKGROUND tries to force THEMED, on failure the control will be painted black." + hb_OsNewLine() + ;
