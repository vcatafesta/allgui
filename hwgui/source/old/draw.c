...
BOOL Array2RectH( PHB_ITEM aRect, RECT * rc )
{
...
HB_FUNC( HWG_GETPPSRECT )
{
   ...
   PHB_ITEM aMetr = Rect2ArrayH( &pps->rcPaint );
...
HB_FUNC( HWG_INFLATERECT )
{
   ...
   if( HB_ISARRAY( 1 ) )
      Array2RectH( hb_param( 1, HB_IT_ARRAY ), &pRect );
...
HB_FUNC( HWG_FRAMERECT )
{
   ...
   if( HB_ISARRAY( 2 ) )
      Array2RectH( hb_param( 2, HB_IT_ARRAY ), &pRect );
...
BOOL Array2PointH( PHB_ITEM aPoint, POINT * pt )
{
...
HB_FUNC( HWG_PTINRECT )
{
   ...
   Array2RectH( hb_param( 1, HB_IT_ARRAY ), &rect );
   Array2PointH( hb_param( 2, HB_IT_ARRAY ), &pt );
...
HB_FUNC( HWG_COPYRECT )
{
   ...
   Array2RectH( hb_param( 1, HB_IT_ARRAY ), &p );
   hb_itemRelease( hb_itemReturn( Rect2ArrayH( &p ) ) );
}
