...
HB_FUNC( HWG_DRAWTHEMEBACKGROUND )
{
   ...
   if( HB_ISARRAY( 5 ) )
      Array2RectH( hb_param( 5, HB_IT_ARRAY ), &pRect );
   if( HB_ISARRAY( 6 ) )
      Array2RectH( hb_param( 6, HB_IT_ARRAY ), &pClipRect );
...
HB_FUNC( HWG_DRAWTHEICON )
{
   ...
   if( HB_ISARRAY( 4 ) )
      Array2RectH( hb_param( 4, HB_IT_ARRAY ), &rpItem );
   if( HB_ISARRAY( 5 ) )
      Array2RectH( hb_param( 5, HB_IT_ARRAY ), &rpTitle );
...
HB_FUNC( HWG_DRAWTHEMETEXT )
{
   ...
   if( HB_ISARRAY( 8 ) )
      Array2RectH( hb_param( 8, HB_IT_ARRAY ), &pRect );
   MultiByteToWideChar( CP_ACP, MB_PRECOMPOSED, pText, -1, output, mlen );
...
HB_FUNC( HWG_DRAWTHEMEPARENTBACKGROUND )
{
   ...
   if( HB_ISARRAY( 3 ) )
      Array2RectH( hb_param( 3, HB_IT_ARRAY ), &pRect );
