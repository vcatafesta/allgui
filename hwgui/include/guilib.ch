/*
 *$Id: guilib.ch 2053 2013-05-28 07:52:13Z alkresin $
 */
...
#xcommand @ <x>,<y> OWNERBUTTON [ <oOwnBtn> ]  ;
             ...
             [ BITMAP <bmp>  [<res: FROM RESOURCE>] [<ltr: BACKTRANSPARENT> [COLOR  <trcolor> ]] ;
...
#xcommand REDEFINE OWNERBUTTON [ <oOwnBtn> ]  ;
             ...
             [ BITMAP <bmp>  [<res: FROM RESOURCE>] [<ltr: BACKTRANSPARENT>] ;
             [ COORDINATES  <xb>, <yb>, <widthb>, <heightb> ] ;
             ] ;
             [ TOOLTIP <ctoolt> ]    ;
             [ <enable: DISABLED> ]  ;
